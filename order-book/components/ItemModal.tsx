            ...
            <TouchableWithoutFeedback onPress={(e) => e.stopPropagation()}>
              <View style={styles.modalView}>
                <View style={styles.modalHorizontal}>
                  <Image source={imageSource} style={{...styles.modalImage, height: cardWidth - 32 }} />
                  <View style={{ flex: 1, paddingLeft: 5 }}>
                    ...
                    <View>
                      <View style={{...styles.modalHorizontal, flexDirection: 'row', marginTop: 0, marginBottom: 0 }}>
                        <Text style={{...styles.modalTextDetail, alignSelf: 'flex-start'}}>Unit Size</Text>
                        <Text style={{...styles.modalTextDetail, alignSelf: 'flex-end'}}>{item.unit_size}ct</Text>
                      </View>
                      <View style={{...styles.modalHorizontal, flexDirection: 'row', marginTop: 0, marginBottom: 0 }}>
                        <Text style={{...styles.modalTextDetail, alignSelf: 'flex-start'}}>Price</Text>
                        <View style={sharedStyles.priceContainer && { alignSelf: 'flex-end', flexDirection: 'row'}}>
